...
2.9.22
#### Modified
- [Cat Demo Scene] Tweaked colors and materials to harmonize scenes between BIRP and URP
- [Shader Generator 1] Removed "TCP2_NONE" keyword and replaced it with "_", which is the correct way to handle no keyword
#### Fixed
- Fixed compilation errors on Unity 6.5
- [Shader Generator 2] Fixed error when removing a Custom Material Property that is used in a property layer override
- [Shader Generator 2] Fixed main color alpha and textures alpha not being used when "Triplanar Mapping" or "Texture Blending" were enabled
