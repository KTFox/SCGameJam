...
namespace vietlabs.fr2
{
    internal partial class FR2_Asset
    {
        ...
        private static Texture s_defaultAssetIcon;
        ...
        private void RefreshDrawCache()
        {
            ...
            var folderContent = !string.IsNullOrEmpty(m_assetFolder) ? FR2_GUIContent.FromString(m_assetFolder) : null;
            m_drawCache.assetFolderWidth = folderContent != null ? EditorStyles.miniLabel.CalcSize(folderContent).x : 0f;
            ...
            if (m_drawCache.cachedIcon == null && !string.IsNullOrEmpty(m_assetPath))
            {
                ...
                if (m_drawCache.cachedIcon == null)
                    m_drawCache.cachedIcon = s_defaultAssetIcon ??= EditorGUIUtility.FindTexture("DefaultAsset Icon");
            }
