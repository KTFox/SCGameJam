...
namespace vietlabs.fr2
{
    internal partial class FR2_Asset
    {
        ...
        private static readonly HashSet<string> SCRIPT_EXTENSIONS = new HashSet<string>(StringComparer.OrdinalIgnoreCase)
        {
            ".cs", ".js", ".boo", ".h", ".java", ".cpp", ".m", ".mm", ".cginclude", ".shadersubgraph"
        };

        private static readonly HashSet<string> REFERENCABLE_EXTENSIONS = new HashSet<string>(StringComparer.OrdinalIgnoreCase)
        {
        ...
        private static readonly HashSet<string> REFERENCABLE_JSON = new HashSet<string>(StringComparer.OrdinalIgnoreCase)
        {
            ".shadergraph", ".shadersubgraph"
        };

        private static readonly HashSet<string> UI_TOOLKIT = new HashSet<string>(StringComparer.OrdinalIgnoreCase)
        {
            ".uss", ".uxml", ".tss"
        };

        private static readonly HashSet<string> REFERENCABLE_META = new HashSet<string>(StringComparer.OrdinalIgnoreCase)
        {
            ".texture2darray",
