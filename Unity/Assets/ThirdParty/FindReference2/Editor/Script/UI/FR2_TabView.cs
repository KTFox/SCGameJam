...
namespace vietlabs.fr2
{
    ...
    internal class FR2_TabView
    {
        ...
        public bool DrawLayout()
        {
            ...
            toolbarRect = GUILayoutUtility.GetRect(0, Screen.width, 22f, 22f);
            ...
            for (var i = 0; i < labels.Length; i++)
            {
                ...
                bool clicked = lb.image != null
                    ? FR2_ToolbarButton.Toggle(tabRect, ref isActive, FR2_GUIContent.FromTexture(lb.image, lb.tooltip))
                    : FR2_ToolbarButton.Toggle(tabRect, ref isActive, lb);
