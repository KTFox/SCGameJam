...
{
    internal partial class FR2_Theme
    {
        public static FR2_Theme Current => EditorGUIUtility.isProSkin ? Dark : Light;
        public static FR2_Theme Dark { get; } = CreateDarkTheme();
        public static FR2_Theme Light { get; } = CreateLightTheme();
        ...
        private GUIStyle _assetNameNormal;
        private GUIStyle _assetNameBoldNormal;
        private GUIStyle _assetNameSelected;
        private GUIStyle _assetNameBoldSelected;
        private GUIStyle _assetPathNormal;
        private GUIStyle _assetPathSelected;

        internal GUIStyle AssetNameNormal => _assetNameNormal ??= BuildStyle(EditorStyles.label, PrimaryTextColor);
        internal GUIStyle AssetNameBoldNormal => _assetNameBoldNormal ??= BuildStyle(EditorStyles.boldLabel, PrimaryTextColor);
        internal GUIStyle AssetNameSelected => _assetNameSelected ??= BuildStyle(EditorStyles.label, SelectedTextColor);
        internal GUIStyle AssetNameBoldSelected => _assetNameBoldSelected ??= BuildStyle(EditorStyles.boldLabel, SelectedTextColor);
        internal GUIStyle AssetPathNormal => _assetPathNormal ??= BuildStyle(EditorStyles.miniLabel, SecondaryTextColor);
        internal GUIStyle AssetPathSelected => _assetPathSelected ??= BuildStyle(EditorStyles.miniLabel, SecondaryTextColor);

        private static GUIStyle BuildStyle(GUIStyle source, Color textColor)
        {
