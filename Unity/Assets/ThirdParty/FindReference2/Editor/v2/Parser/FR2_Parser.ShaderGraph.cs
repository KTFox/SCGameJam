...
{
    internal static partial class FR2_Parser // ShaderGraph
    {
        ...
        private static void ReadContent_ShaderGraph(Func<string, (string, long)> lineParser, string assetPath, Action<string, long> callback)
        {
